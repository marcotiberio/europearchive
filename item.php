    ...
    <div class="separator">
        <svg id="separatorDesktop" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="2" viewBox="0 0 611.746 2">
            ...
            <g id="Group_14" data-name="Group 14" transform="translate(0 2)">
                <g id="Group_13" data-name="Group 13" transform="translate(0 -2)" clip-path="url(#clip-path)">
                <g id="Group_12" data-name="Group 12" transform="translate(0 1)">
                    <path id="Path_10" data-name="Path 10" d="M0,0H611.746" fill="none" stroke="#2b2e34" stroke-width="2"/>
                </g>
                </g>
            </g>
        </svg>
